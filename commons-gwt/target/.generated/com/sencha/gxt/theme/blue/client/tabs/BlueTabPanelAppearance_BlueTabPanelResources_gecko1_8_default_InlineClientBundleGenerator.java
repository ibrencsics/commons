...
public class BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator implements com.sencha.gxt.theme.blue.client.tabs.BlueTabPanelAppearance.BlueTabPanelResources {
  private static BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator _instance0 = new BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator();
  ...
  private void styleInitializer() {
    style = new com.sencha.gxt.theme.blue.client.tabs.BlueTabPanelAppearance.BlueTabPanelStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GBOGIYXDH3B{overflow:" + ("hidden")  + ";outline:" + ("none")  + ";}.GBOGIYXDC4B,.GBOGIYXDA4B{border:" + ("1px"+ " " +"solid")  + ";overflow:" + ("hidden")  + ";}.GBOGIYXDC4B{border:" + ("1px"+ " " +"solid")  + ";padding-bottom:" + ("2px")  + ";}.GBOGIYXDA4B{border:" + ("1px"+ " " +"solid")  + ";padding-top:" + ("2px")  + ";}.GBOGIYXDK5B{width:" + ("100%")  + ";overflow:" + ("hidden")  + ";position:") + (("relative")  + ";}.GBOGIYXDA5B{display:" + ("block")  + ";width:" + ("1000000px")  + ";}.GBOGIYXDJ5B{margin-top:" + ("1px")  + ";background:" + ("repeat-x"+ " " +"bottom")  + ";border-bottom:" + ("1px"+ " " +"solid")  + ";}.GBOGIYXDC5B{padding-bottom:" + ("1px")  + ";background:" + ("repeat-x"+ " " +"top")  + ";border-top:" + ("1px"+ " " +"solid")  + ";border-bottom:" + ("0"+ " " +"none")  + ";}.GBOGIYXDA5B li{float:" + ("right") ) + (";position:" + ("relative")  + ";margin-right:" + ("2px")  + ";}.GBOGIYXDA5B li.GBOGIYXDP3B{float:" + ("right")  + ";margin:" + ("0")  + " !important;padding:" + ("0")  + " !important;border:" + ("0"+ " " +"none")  + " !important;font-size:" + ("1px")  + " !important;line-height:" + ("1px")  + " !important;overflow:" + ("hidden")  + ";background:" + ("transparent")  + " !important;width:") + (("1px")  + ";}.GBOGIYXDA5B a{display:" + ("block")  + ";text-decoration:" + ("none")  + " !important;cursor:" + ("pointer")  + ";outline:" + ("none")  + ";}.GBOGIYXDA5B span,.GBOGIYXDA5B em{display:" + ("block")  + ";}.GBOGIYXDG5B{overflow:" + ("hidden")  + ";text-overflow:" + ("ellipsis")  + ";}.GBOGIYXDA5B span.GBOGIYXDI5B{white-space:" + ("nowrap")  + ";cursor:" + ("pointer")  + ";padding:" + ("4px"+ " " +"0") ) + (";font:" + ("normal"+ " " +"11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica")  + ";color:" + ("#416aa3")  + ";}.GBOGIYXDJ5B .GBOGIYXDN5B .GBOGIYXDH4B{padding-right:" + ("6px")  + ";}.GBOGIYXDA5B .GBOGIYXDN5B span.GBOGIYXDI5B{padding-right:" + ("20px")  + ";background-position:" + ("0"+ " " +"3px")  + ";background-repeat:" + ("no-repeat")  + ";}.GBOGIYXDB5B,.GBOGIYXDB5B a.GBOGIYXDH4B,.GBOGIYXDB5B span.GBOGIYXDI5B,.GBOGIYXDF5B .GBOGIYXDO5B{cursor:" + ("default")  + ";}.GBOGIYXDK3B{overflow:" + ("hidden")  + ";border:" + ("1px"+ " " +"solid")  + ";}.GBOGIYXDO3B{overflow:" + ("hidden")  + ";}.GBOGIYXDJ5B .GBOGIYXDB5B .GBOGIYXDH4B{margin-bottom:") + (("-1px")  + ";}.GBOGIYXDJ5B .GBOGIYXDB5B .GBOGIYXDH4B span.GBOGIYXDI5B{padding-bottom:" + ("5px")  + ";}.GBOGIYXDC5B .GBOGIYXDB5B .GBOGIYXDH4B{margin-top:" + ("-1px")  + ";}.GBOGIYXDC5B .GBOGIYXDB5B .GBOGIYXDH4B span.GBOGIYXDI5B{padding-top:" + ("5px")  + ";}.GBOGIYXDC5B .GBOGIYXDF4B{padding:" + ("0"+ " " +"10px")  + ";}.GBOGIYXDC5B .GBOGIYXDH4B{padding:" + ("0")  + ";}.GBOGIYXDA5B .GBOGIYXDE5B{display:" + ("none")  + ";}.GBOGIYXDD5B{position:" + ("relative")  + ";}.GBOGIYXDD5B .GBOGIYXDF4B{padding-left:" + ("19px")  + ";}.GBOGIYXDA5B .GBOGIYXDD5B a.GBOGIYXDE5B{background-repeat:" + ("no-repeat")  + ";display:" + ("block") ) + (";width:" + ("11px")  + ";height:" + ("11px")  + ";position:" + ("absolute")  + ";top:" + ("3px")  + ";left:" + ("3px")  + ";cursor:" + ("pointer")  + ";z-index:" + ("2")  + ";opacity:" + ("0.6")  + ";}.GBOGIYXDA5B .GBOGIYXDB5B a.GBOGIYXDE5B{opacity:" + ("0.8")  + ";}.GBOGIYXDA5B .GBOGIYXDD5B a.GBOGIYXDE5B:hover{opacity:" + ("1")  + ";}.GBOGIYXDN3B{border-top:") + (("0"+ " " +"none")  + ";}.GBOGIYXDL3B{border-bottom:" + ("0"+ " " +"none")  + ";}.GBOGIYXDI4B{background:" + ("transparent"+ " " +"no-repeat"+ " " +"-18px"+ " " +"0")  + ";border-bottom:" + ("1px"+ " " +"solid")  + ";width:" + ("18px")  + ";position:" + ("absolute")  + ";right:" + ("0")  + ";top:" + ("0")  + ";z-index:" + ("10")  + ";cursor:" + ("pointer")  + ";}.GBOGIYXDJ4B,.GBOGIYXDM4B{cursor:" + ("default") ) + (";opacity:" + ("0.5")  + ";}.GBOGIYXDL4B{background:" + ("transparent"+ " " +"no-repeat"+ " " +"0"+ " " +"0")  + ";border-bottom:" + ("1px"+ " " +"solid")  + ";width:" + ("18px")  + ";position:" + ("absolute")  + ";left:" + ("0")  + ";top:" + ("0")  + ";z-index:" + ("10")  + ";cursor:" + ("pointer")  + ";}.GBOGIYXDP4B .GBOGIYXDI4B,.GBOGIYXDP4B .GBOGIYXDL4B{margin-top:" + ("1px")  + ";}.GBOGIYXDO4B .GBOGIYXDK5B{margin-right:") + (("18px")  + ";margin-left:" + ("18px")  + ";}.GBOGIYXDO4B{position:" + ("relative")  + ";}.GBOGIYXDI3B .GBOGIYXDP5B,.GBOGIYXDL5B .GBOGIYXDP5B{border:" + ("1px"+ " " +"solid")  + ";border-top:" + ("0"+ " " +"none")  + ";overflow:" + ("hidden")  + ";padding:" + ("2px")  + ";}.GBOGIYXDA5B li .GBOGIYXDE4B{position:" + ("absolute")  + ";top:" + ("3px")  + ";right:" + ("5px")  + ";}.GBOGIYXDJ5B .GBOGIYXDH4B{top:" + ("0") ) + (";height:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeft()).getHeight() + "px")  + ";width:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeft()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeft()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeft()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeft()).getTop() + "px  no-repeat")  + ";padding-right:" + ("10px")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";}.GBOGIYXDJ5B .GBOGIYXDF4B{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabRight()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabRight()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabRight()).getTop() + "px  repeat")  + ";padding-left:" + ("10px")  + ";width:") + (("auto")  + ";height:" + ("auto")  + ";background-position:" + ("top"+ " " +"left")  + ";background-repeat:" + ("no-repeat")  + ";}.GBOGIYXDD5B .GBOGIYXDF4B{padding-left:" + ("19px")  + ";}.GBOGIYXDJ5B .GBOGIYXDG5B{height:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabCenter()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabCenter()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabCenter()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabCenter()).getTop() + "px  repeat-x")  + ";height:" + ("auto")  + ";}.GBOGIYXDJ5B .GBOGIYXDH5B .GBOGIYXDH4B{height:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeftOver()).getHeight() + "px")  + ";width:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeftOver()).getWidth() + "px") ) + (";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeftOver()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeftOver()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeftOver()).getTop() + "px  no-repeat")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";}.GBOGIYXDJ5B .GBOGIYXDH5B .GBOGIYXDF4B{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabRightOver()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabRightOver()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabRightOver()).getTop() + "px  repeat")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";background-position:" + ("top"+ " " +"left")  + ";background-repeat:" + ("no-repeat")  + ";}.GBOGIYXDJ5B .GBOGIYXDH5B .GBOGIYXDG5B{height:") + (((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabCenterOver()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabCenterOver()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabCenterOver()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabCenterOver()).getTop() + "px  repeat-x")  + ";height:" + ("auto")  + ";}.GBOGIYXDJ5B .GBOGIYXDB5B .GBOGIYXDH4B{height:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeftActive()).getHeight() + "px")  + ";width:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeftActive()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeftActive()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeftActive()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeftActive()).getTop() + "px  no-repeat")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";}.GBOGIYXDJ5B .GBOGIYXDB5B .GBOGIYXDF4B{overflow:" + ("hidden") ) + (";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabRightActive()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabRightActive()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabRightActive()).getTop() + "px  repeat")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";background-position:" + ("top"+ " " +"left")  + ";background-repeat:" + ("no-repeat")  + ";}.GBOGIYXDJ5B .GBOGIYXDB5B .GBOGIYXDG5B{height:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabCenterActive()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabCenterActive()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabCenterActive()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabCenterActive()).getTop() + "px  repeat-x")  + ";height:" + ("auto")  + ";}.GBOGIYXDC4B,.GBOGIYXDA4B{background-color:" + ("#deecfd")  + ";border-color:") + (("#8db2e3")  + ";}.GBOGIYXDJ5B{height:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabStripBackground()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabStripBackground()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabStripBackground()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabStripBackground()).getTop() + "px  repeat-x")  + ";background-color:" + ("#cedff5")  + ";border-bottom-color:" + ("#8db2e3")  + ";height:" + ("auto")  + ";overflow:" + ("visible")  + ";}.GBOGIYXDC5B{height:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabStripBottomBackground()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabStripBottomBackground()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabStripBottomBackground()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabStripBottomBackground()).getTop() + "px  repeat-x") ) + (";background-color:" + ("#cedff5")  + ";border-top-color:" + ("#8db2e3")  + ";height:" + ("auto")  + ";overflow:" + ("visible")  + ";}.GBOGIYXDH5B span.GBOGIYXDI5B{color:" + ("#15428b")  + ";}.GBOGIYXDB5B span.GBOGIYXDI5B{color:" + ("#15428b")  + ";font-weight:" + ("bold")  + ";}.GBOGIYXDF5B .GBOGIYXDO5B{color:" + ("#aaa")  + ";}.GBOGIYXDC5B .GBOGIYXDH4B{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.bottomInactiveRightBackground()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.bottomInactiveRightBackground()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.bottomInactiveRightBackground()).getTop() + "px  repeat")  + ";background-position:") + (("bottom"+ " " +"left")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";background-repeat:" + ("no-repeat")  + ";}.GBOGIYXDC5B .GBOGIYXDF4B{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.bottomInactiveLeftBackground()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.bottomInactiveLeftBackground()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.bottomInactiveLeftBackground()).getTop() + "px  repeat")  + ";background-position:" + ("bottom"+ " " +"right")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";background-repeat:" + ("no-repeat")  + ";}.GBOGIYXDC5B .GBOGIYXDB5B .GBOGIYXDH4B{overflow:" + ("hidden") ) + (";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.bottomRightBackground()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.bottomRightBackground()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.bottomRightBackground()).getTop() + "px  repeat")  + ";background-position:" + ("bottom"+ " " +"right")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";background-repeat:" + ("no-repeat")  + ";}.GBOGIYXDC5B .GBOGIYXDB5B .GBOGIYXDF4B{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.bottomLeftBackground()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.bottomLeftBackground()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.bottomLeftBackground()).getTop() + "px  repeat")  + ";background-position:" + ("bottom"+ " " +"left")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";background-repeat:") + (("no-repeat")  + ";}.GBOGIYXDA5B .GBOGIYXDD5B a.GBOGIYXDE5B,.GBOGIYXDA5B .GBOGIYXDD5B a.GBOGIYXDE5B:hover{height:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabClose()).getHeight() + "px")  + ";width:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabClose()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabClose()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabClose()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabClose()).getTop() + "px  no-repeat")  + ";}.GBOGIYXDK3B{border-color:" + ("#8db2e3")  + ";background-color:" + ("#fff")  + ";}.GBOGIYXDN3B{border-top:" + ("0"+ " " +"none")  + ";}.GBOGIYXDL3B{border-bottom:" + ("0"+ " " +"none")  + ";}.GBOGIYXDI4B{height:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerLeft()).getHeight() + "px")  + ";width:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerLeft()).getWidth() + "px") ) + (";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerLeft()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerLeft()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerLeft()).getTop() + "px  no-repeat")  + ";border-bottom-color:" + ("#8db2e3")  + ";}.GBOGIYXDK4B{height:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerLeftOver()).getHeight() + "px")  + ";width:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerLeftOver()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerLeftOver()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerLeftOver()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerLeftOver()).getTop() + "px  no-repeat")  + ";}.GBOGIYXDL4B{height:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerRight()).getHeight() + "px")  + ";width:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerRight()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:") + (("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerRight()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerRight()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerRight()).getTop() + "px  no-repeat")  + ";border-bottom-color:" + ("#8db2e3")  + ";}.GBOGIYXDN4B{height:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerRightOver()).getHeight() + "px")  + ";width:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerRightOver()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerRightOver()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerRightOver()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerRightOver()).getTop() + "px  no-repeat")  + ";}.GBOGIYXDI3B .GBOGIYXDP5B,.GBOGIYXDL5B .GBOGIYXDP5B{border-color:" + ("#99bbe8")  + ";}.GBOGIYXDG4B .GBOGIYXDM3B{border-width:" + ("0")  + ";}.GBOGIYXDG4B .GBOGIYXDD4B{border-width:" + ("0"+ " " +"0"+ " " +"1px"+ " " +"0")  + ";}.GBOGIYXDG4B .GBOGIYXDB4B{border-width:" + ("1px"+ " " +"0"+ " " +"0"+ " " +"0")  + ";}.GBOGIYXDJ3B .GBOGIYXDP5B{border-width:" + ("1px"+ " " +"0"+ " " +"0"+ " " +"0") ) + (";border-style:" + ("solid")  + ";border-top-color:" + ("#99bbe8")  + ";}.GBOGIYXDM5B .GBOGIYXDP5B{border-width:" + ("0"+ " " +"0"+ " " +"1px")  + ";border-style:" + ("solid")  + ";border-bottom-color:" + ("#99bbe8")  + ";}")) : ((".GBOGIYXDH3B{overflow:" + ("hidden")  + ";outline:" + ("none")  + ";}.GBOGIYXDC4B,.GBOGIYXDA4B{border:" + ("1px"+ " " +"solid")  + ";overflow:" + ("hidden")  + ";}.GBOGIYXDC4B{border:" + ("1px"+ " " +"solid")  + ";padding-bottom:" + ("2px")  + ";}.GBOGIYXDA4B{border:" + ("1px"+ " " +"solid")  + ";padding-top:" + ("2px")  + ";}.GBOGIYXDK5B{width:" + ("100%")  + ";overflow:" + ("hidden")  + ";position:") + (("relative")  + ";}.GBOGIYXDA5B{display:" + ("block")  + ";width:" + ("1000000px")  + ";}.GBOGIYXDJ5B{margin-top:" + ("1px")  + ";background:" + ("repeat-x"+ " " +"bottom")  + ";border-bottom:" + ("1px"+ " " +"solid")  + ";}.GBOGIYXDC5B{padding-bottom:" + ("1px")  + ";background:" + ("repeat-x"+ " " +"top")  + ";border-top:" + ("1px"+ " " +"solid")  + ";border-bottom:" + ("0"+ " " +"none")  + ";}.GBOGIYXDA5B li{float:" + ("left") ) + (";position:" + ("relative")  + ";margin-left:" + ("2px")  + ";}.GBOGIYXDA5B li.GBOGIYXDP3B{float:" + ("left")  + ";margin:" + ("0")  + " !important;padding:" + ("0")  + " !important;border:" + ("0"+ " " +"none")  + " !important;font-size:" + ("1px")  + " !important;line-height:" + ("1px")  + " !important;overflow:" + ("hidden")  + ";background:" + ("transparent")  + " !important;width:") + (("1px")  + ";}.GBOGIYXDA5B a{display:" + ("block")  + ";text-decoration:" + ("none")  + " !important;cursor:" + ("pointer")  + ";outline:" + ("none")  + ";}.GBOGIYXDA5B span,.GBOGIYXDA5B em{display:" + ("block")  + ";}.GBOGIYXDG5B{overflow:" + ("hidden")  + ";text-overflow:" + ("ellipsis")  + ";}.GBOGIYXDA5B span.GBOGIYXDI5B{white-space:" + ("nowrap")  + ";cursor:" + ("pointer")  + ";padding:" + ("4px"+ " " +"0") ) + (";font:" + ("normal"+ " " +"11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica")  + ";color:" + ("#416aa3")  + ";}.GBOGIYXDJ5B .GBOGIYXDN5B .GBOGIYXDH4B{padding-left:" + ("6px")  + ";}.GBOGIYXDA5B .GBOGIYXDN5B span.GBOGIYXDI5B{padding-left:" + ("20px")  + ";background-position:" + ("0"+ " " +"3px")  + ";background-repeat:" + ("no-repeat")  + ";}.GBOGIYXDB5B,.GBOGIYXDB5B a.GBOGIYXDH4B,.GBOGIYXDB5B span.GBOGIYXDI5B,.GBOGIYXDF5B .GBOGIYXDO5B{cursor:" + ("default")  + ";}.GBOGIYXDK3B{overflow:" + ("hidden")  + ";border:" + ("1px"+ " " +"solid")  + ";}.GBOGIYXDO3B{overflow:" + ("hidden")  + ";}.GBOGIYXDJ5B .GBOGIYXDB5B .GBOGIYXDH4B{margin-bottom:") + (("-1px")  + ";}.GBOGIYXDJ5B .GBOGIYXDB5B .GBOGIYXDH4B span.GBOGIYXDI5B{padding-bottom:" + ("5px")  + ";}.GBOGIYXDC5B .GBOGIYXDB5B .GBOGIYXDH4B{margin-top:" + ("-1px")  + ";}.GBOGIYXDC5B .GBOGIYXDB5B .GBOGIYXDH4B span.GBOGIYXDI5B{padding-top:" + ("5px")  + ";}.GBOGIYXDC5B .GBOGIYXDF4B{padding:" + ("0"+ " " +"10px")  + ";}.GBOGIYXDC5B .GBOGIYXDH4B{padding:" + ("0")  + ";}.GBOGIYXDA5B .GBOGIYXDE5B{display:" + ("none")  + ";}.GBOGIYXDD5B{position:" + ("relative")  + ";}.GBOGIYXDD5B .GBOGIYXDF4B{padding-right:" + ("19px")  + ";}.GBOGIYXDA5B .GBOGIYXDD5B a.GBOGIYXDE5B{background-repeat:" + ("no-repeat")  + ";display:" + ("block") ) + (";width:" + ("11px")  + ";height:" + ("11px")  + ";position:" + ("absolute")  + ";top:" + ("3px")  + ";right:" + ("3px")  + ";cursor:" + ("pointer")  + ";z-index:" + ("2")  + ";opacity:" + ("0.6")  + ";}.GBOGIYXDA5B .GBOGIYXDB5B a.GBOGIYXDE5B{opacity:" + ("0.8")  + ";}.GBOGIYXDA5B .GBOGIYXDD5B a.GBOGIYXDE5B:hover{opacity:" + ("1")  + ";}.GBOGIYXDN3B{border-top:") + (("0"+ " " +"none")  + ";}.GBOGIYXDL3B{border-bottom:" + ("0"+ " " +"none")  + ";}.GBOGIYXDI4B{background:" + ("transparent"+ " " +"no-repeat"+ " " +"-18px"+ " " +"0")  + ";border-bottom:" + ("1px"+ " " +"solid")  + ";width:" + ("18px")  + ";position:" + ("absolute")  + ";left:" + ("0")  + ";top:" + ("0")  + ";z-index:" + ("10")  + ";cursor:" + ("pointer")  + ";}.GBOGIYXDJ4B,.GBOGIYXDM4B{cursor:" + ("default") ) + (";opacity:" + ("0.5")  + ";}.GBOGIYXDL4B{background:" + ("transparent"+ " " +"no-repeat"+ " " +"0"+ " " +"0")  + ";border-bottom:" + ("1px"+ " " +"solid")  + ";width:" + ("18px")  + ";position:" + ("absolute")  + ";right:" + ("0")  + ";top:" + ("0")  + ";z-index:" + ("10")  + ";cursor:" + ("pointer")  + ";}.GBOGIYXDP4B .GBOGIYXDI4B,.GBOGIYXDP4B .GBOGIYXDL4B{margin-top:" + ("1px")  + ";}.GBOGIYXDO4B .GBOGIYXDK5B{margin-left:") + (("18px")  + ";margin-right:" + ("18px")  + ";}.GBOGIYXDO4B{position:" + ("relative")  + ";}.GBOGIYXDI3B .GBOGIYXDP5B,.GBOGIYXDL5B .GBOGIYXDP5B{border:" + ("1px"+ " " +"solid")  + ";border-top:" + ("0"+ " " +"none")  + ";overflow:" + ("hidden")  + ";padding:" + ("2px")  + ";}.GBOGIYXDA5B li .GBOGIYXDE4B{position:" + ("absolute")  + ";top:" + ("3px")  + ";left:" + ("5px")  + ";}.GBOGIYXDJ5B .GBOGIYXDH4B{top:" + ("0") ) + (";height:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeft()).getHeight() + "px")  + ";width:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeft()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeft()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeft()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeft()).getTop() + "px  no-repeat")  + ";padding-left:" + ("10px")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";}.GBOGIYXDJ5B .GBOGIYXDF4B{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabRight()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabRight()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabRight()).getTop() + "px  repeat")  + ";padding-right:" + ("10px")  + ";width:") + (("auto")  + ";height:" + ("auto")  + ";background-position:" + ("top"+ " " +"right")  + ";background-repeat:" + ("no-repeat")  + ";}.GBOGIYXDD5B .GBOGIYXDF4B{padding-right:" + ("19px")  + ";}.GBOGIYXDJ5B .GBOGIYXDG5B{height:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabCenter()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabCenter()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabCenter()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabCenter()).getTop() + "px  repeat-x")  + ";height:" + ("auto")  + ";}.GBOGIYXDJ5B .GBOGIYXDH5B .GBOGIYXDH4B{height:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeftOver()).getHeight() + "px")  + ";width:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeftOver()).getWidth() + "px") ) + (";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeftOver()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeftOver()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeftOver()).getTop() + "px  no-repeat")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";}.GBOGIYXDJ5B .GBOGIYXDH5B .GBOGIYXDF4B{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabRightOver()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabRightOver()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabRightOver()).getTop() + "px  repeat")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";background-position:" + ("top"+ " " +"right")  + ";background-repeat:" + ("no-repeat")  + ";}.GBOGIYXDJ5B .GBOGIYXDH5B .GBOGIYXDG5B{height:") + (((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabCenterOver()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabCenterOver()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabCenterOver()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabCenterOver()).getTop() + "px  repeat-x")  + ";height:" + ("auto")  + ";}.GBOGIYXDJ5B .GBOGIYXDB5B .GBOGIYXDH4B{height:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeftActive()).getHeight() + "px")  + ";width:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeftActive()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeftActive()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeftActive()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabLeftActive()).getTop() + "px  no-repeat")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";}.GBOGIYXDJ5B .GBOGIYXDB5B .GBOGIYXDF4B{overflow:" + ("hidden") ) + (";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabRightActive()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabRightActive()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabRightActive()).getTop() + "px  repeat")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";background-position:" + ("top"+ " " +"right")  + ";background-repeat:" + ("no-repeat")  + ";}.GBOGIYXDJ5B .GBOGIYXDB5B .GBOGIYXDG5B{height:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabCenterActive()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabCenterActive()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabCenterActive()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabCenterActive()).getTop() + "px  repeat-x")  + ";height:" + ("auto")  + ";}.GBOGIYXDC4B,.GBOGIYXDA4B{background-color:" + ("#deecfd")  + ";border-color:") + (("#8db2e3")  + ";}.GBOGIYXDJ5B{height:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabStripBackground()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabStripBackground()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabStripBackground()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabStripBackground()).getTop() + "px  repeat-x")  + ";background-color:" + ("#cedff5")  + ";border-bottom-color:" + ("#8db2e3")  + ";height:" + ("auto")  + ";overflow:" + ("visible")  + ";}.GBOGIYXDC5B{height:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabStripBottomBackground()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabStripBottomBackground()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabStripBottomBackground()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabStripBottomBackground()).getTop() + "px  repeat-x") ) + (";background-color:" + ("#cedff5")  + ";border-top-color:" + ("#8db2e3")  + ";height:" + ("auto")  + ";overflow:" + ("visible")  + ";}.GBOGIYXDH5B span.GBOGIYXDI5B{color:" + ("#15428b")  + ";}.GBOGIYXDB5B span.GBOGIYXDI5B{color:" + ("#15428b")  + ";font-weight:" + ("bold")  + ";}.GBOGIYXDF5B .GBOGIYXDO5B{color:" + ("#aaa")  + ";}.GBOGIYXDC5B .GBOGIYXDH4B{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.bottomInactiveRightBackground()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.bottomInactiveRightBackground()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.bottomInactiveRightBackground()).getTop() + "px  repeat")  + ";background-position:") + (("bottom"+ " " +"right")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";background-repeat:" + ("no-repeat")  + ";}.GBOGIYXDC5B .GBOGIYXDF4B{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.bottomInactiveLeftBackground()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.bottomInactiveLeftBackground()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.bottomInactiveLeftBackground()).getTop() + "px  repeat")  + ";background-position:" + ("bottom"+ " " +"left")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";background-repeat:" + ("no-repeat")  + ";}.GBOGIYXDC5B .GBOGIYXDB5B .GBOGIYXDH4B{overflow:" + ("hidden") ) + (";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.bottomRightBackground()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.bottomRightBackground()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.bottomRightBackground()).getTop() + "px  repeat")  + ";background-position:" + ("bottom"+ " " +"left")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";background-repeat:" + ("no-repeat")  + ";}.GBOGIYXDC5B .GBOGIYXDB5B .GBOGIYXDF4B{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.bottomLeftBackground()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.bottomLeftBackground()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.bottomLeftBackground()).getTop() + "px  repeat")  + ";background-position:" + ("bottom"+ " " +"right")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";background-repeat:") + (("no-repeat")  + ";}.GBOGIYXDA5B .GBOGIYXDD5B a.GBOGIYXDE5B,.GBOGIYXDA5B .GBOGIYXDD5B a.GBOGIYXDE5B:hover{height:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabClose()).getHeight() + "px")  + ";width:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabClose()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabClose()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabClose()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.tabClose()).getTop() + "px  no-repeat")  + ";}.GBOGIYXDK3B{border-color:" + ("#8db2e3")  + ";background-color:" + ("#fff")  + ";}.GBOGIYXDN3B{border-top:" + ("0"+ " " +"none")  + ";}.GBOGIYXDL3B{border-bottom:" + ("0"+ " " +"none")  + ";}.GBOGIYXDI4B{height:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerLeft()).getHeight() + "px")  + ";width:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerLeft()).getWidth() + "px") ) + (";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerLeft()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerLeft()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerLeft()).getTop() + "px  no-repeat")  + ";border-bottom-color:" + ("#8db2e3")  + ";}.GBOGIYXDK4B{height:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerLeftOver()).getHeight() + "px")  + ";width:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerLeftOver()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerLeftOver()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerLeftOver()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerLeftOver()).getTop() + "px  no-repeat")  + ";}.GBOGIYXDL4B{height:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerRight()).getHeight() + "px")  + ";width:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerRight()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:") + (("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerRight()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerRight()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerRight()).getTop() + "px  no-repeat")  + ";border-bottom-color:" + ("#8db2e3")  + ";}.GBOGIYXDN4B{height:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerRightOver()).getHeight() + "px")  + ";width:" + ((BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerRightOver()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerRightOver()).getSafeUri().asString() + "\") -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerRightOver()).getLeft() + "px -" + (BlueTabPanelAppearance_BlueTabPanelResources_gecko1_8_default_InlineClientBundleGenerator.this.scrollerRightOver()).getTop() + "px  no-repeat")  + ";}.GBOGIYXDI3B .GBOGIYXDP5B,.GBOGIYXDL5B .GBOGIYXDP5B{border-color:" + ("#99bbe8")  + ";}.GBOGIYXDG4B .GBOGIYXDM3B{border-width:" + ("0")  + ";}.GBOGIYXDG4B .GBOGIYXDD4B{border-width:" + ("0"+ " " +"0"+ " " +"1px"+ " " +"0")  + ";}.GBOGIYXDG4B .GBOGIYXDB4B{border-width:" + ("1px"+ " " +"0"+ " " +"0"+ " " +"0")  + ";}.GBOGIYXDJ3B .GBOGIYXDP5B{border-width:" + ("1px"+ " " +"0"+ " " +"0"+ " " +"0") ) + (";border-style:" + ("solid")  + ";border-top-color:" + ("#99bbe8")  + ";}.GBOGIYXDM5B .GBOGIYXDP5B{border-width:" + ("0"+ " " +"0"+ " " +"1px")  + ";border-style:" + ("solid")  + ";border-bottom-color:" + ("#99bbe8")  + ";}"));
      }
