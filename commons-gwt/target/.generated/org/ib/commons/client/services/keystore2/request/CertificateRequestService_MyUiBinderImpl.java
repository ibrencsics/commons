...
public class CertificateRequestService_MyUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, org.ib.commons.client.services.keystore2.request.CertificateRequestService>, org.ib.commons.client.services.keystore2.request.CertificateRequestService.MyUiBinder {

  interface Template extends SafeHtmlTemplates {
    @Template("<table> <tr> <td><span id='{0}'></span></td> <td><span id='{1}'></span></td> </tr> <tr> <td><span id='{2}'></span></td> <td><span id='{3}'></span></td> </tr> <tr> <td><span id='{4}'></span></td> <td><span id='{5}'></span></td> </tr> </table>")
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final org.ib.commons.client.services.keystore2.request.CertificateRequestService owner) {

    org.ib.commons.client.services.keystore2.request.CertificateRequestService_MyUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (org.ib.commons.client.services.keystore2.request.CertificateRequestService_MyUiBinderImpl_GenBundle) GWT.create(org.ib.commons.client.services.keystore2.request.CertificateRequestService_MyUiBinderImpl_GenBundle.class);
    org.ib.commons.client.services.keystore2.request.CertificateRequestService_MyUiBinderImpl_GenCss_style style = clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay.style();
    ...
    com.google.gwt.user.client.ui.TextBox tbAlgorithm = (com.google.gwt.user.client.ui.TextBox) GWT.create(com.google.gwt.user.client.ui.TextBox.class);
    com.google.gwt.user.client.ui.HTMLPanel f_HTMLPanel4 = new com.google.gwt.user.client.ui.HTMLPanel(template.html1(domId0, domId1, domId2, domId3, domId4, domId5).asString());
    com.google.gwt.user.client.ui.Button btnCertReq = (com.google.gwt.user.client.ui.Button) GWT.create(com.google.gwt.user.client.ui.Button.class);
    ...
    org.ib.commons.client.services.keystore2.request.CertificateRequestList certReqList = new org.ib.commons.client.services.keystore2.request.CertificateRequestList("300px", "400px");
    ...
    f_Label6.setText("Subject DN");
    f_Label7.setText("Algorithm");
    f_VerticalLayoutContainer3.add(f_HTMLPanel4);
    btnCertReq.setStyleName("button");
    btnCertReq.setText("Create");
    f_VerticalLayoutContainer3.add(btnCertReq);
    f_FramedPanel2.add(f_VerticalLayoutContainer3);
    f_FramedPanel2.setHeadingText("New Certificate Request");
    ...
    f_VerticalPanel8.add(btnRefresh);
    f_VerticalLayoutContainer1.add(f_VerticalPanel8, middleData);
    f_VerticalLayoutContainer1.add(certReqList, bottomData);
    ...
    f_HTMLPanel4.addAndReplaceElement(tbName, domId1Element);
    f_HTMLPanel4.addAndReplaceElement(f_Label6, domId2Element);
    f_HTMLPanel4.addAndReplaceElement(tbSubjectDN, domId3Element);
    f_HTMLPanel4.addAndReplaceElement(f_Label7, domId4Element);
    f_HTMLPanel4.addAndReplaceElement(tbAlgorithm, domId5Element);
    ...
    btnCertReq.addClickHandler(handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames2);

    owner.btnCertReq = btnCertReq;
    owner.btnRefresh = btnRefresh;
    owner.certReqList = certReqList;
    owner.tbAlgorithm = tbAlgorithm;
    owner.tbName = tbName;
