 ...
 */
public class commonsTest extends GWTTestCase {

  /**
   * Must refer to a valid module that sources this class.
   */
  public String getModuleName() {
    return "org.ib.commons.commonsJUnit";
  }
  ...
  public void testGreetingService() {
    ...
    BackendServiceAsync greetingService = GWT.create(BackendService.class);
    ServiceDefTarget target = (ServiceDefTarget) greetingService;
    target.setServiceEntryPoint(GWT.getModuleBaseURL() + "commons/greet");
