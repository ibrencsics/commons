 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://namespaces.globalplatform.org/systems-profiles/1.1.1}LoadFileInstance" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "LoadFileInstances")
public class LoadFileInstances {

    @XmlElement(name = "LoadFileInstance")
