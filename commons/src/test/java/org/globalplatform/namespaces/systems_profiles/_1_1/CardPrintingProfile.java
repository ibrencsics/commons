 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://namespaces.globalplatform.org/systems-profiles/1.1.1}CardDesignOrientation"/>
 *         &lt;element ref="{http://namespaces.globalplatform.org/systems-profiles/1.1.1}CardDesignOrigin"/>
 *         &lt;element ref="{http://namespaces.globalplatform.org/systems-profiles/1.1.1}ConfigurationID" minOccurs="0"/>
 *         &lt;element ref="{http://namespaces.globalplatform.org/systems-profiles/1.1.1}CardStockID" minOccurs="0"/>
 *         &lt;element ref="{http://namespaces.globalplatform.org/systems-profiles/1.1.1}PersonalizationOrderConstraint" maxOccurs="unbounded"/>
 *         &lt;element name="Emboss" type="{http://namespaces.globalplatform.org/systems-profiles/1.1.1}Emboss" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="Label" type="{http://namespaces.globalplatform.org/systems-profiles/1.1.1}Label" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="MagneticEncoding" type="{http://namespaces.globalplatform.org/systems-profiles/1.1.1}MagneticEncodingType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="Overlay" type="{http://namespaces.globalplatform.org/systems-profiles/1.1.1}Overlay" minOccurs="0"/>
 *         &lt;element name="Barcode" type="{http://namespaces.globalplatform.org/systems-profiles/1.1.1}Barcode" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="Text" type="{http://namespaces.globalplatform.org/systems-profiles/1.1.1}Text" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="Image" type="{http://namespaces.globalplatform.org/systems-profiles/1.1.1}Image" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
